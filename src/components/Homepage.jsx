...
const Homepage=()=> {
  return (
    <div className="flex bg-blue-500 h-screen w-full flex-col  ">
      ...
      <div className="flex h-96 w-full bg-orange-300 flex-row ">
        <div className='flex border border-black h-full w-3/5 flex-col'>
          <div className="flex w-full h-5/6 border border-black text-black font-bold text-7xl font-serif"><h1>Grab Upto 50% off on Selected Products</h1></div>
          <div className="flex h-full w-2/6 items-center justify-center">
            <div className="flex bg-teal-800 w-36 h-10 justify-center text-xl "><button>Buy Now</button></div>
          </div>
        </div>
